...
namespace BitirmeDRM.UI
{
    public class HWID
    {
        ...
        public string Value()
        {
            ...
            {
                _fingerPrint = GetHash("CPUID: " + CpuId() + "SYSTEMNAME: " + SystemName() + " Hard Disk Serial Number: " + DiskNo() + " Signature: " + DiskSignature());
            }
            return _fingerPrint;
        }
        ...
        {
            return Identifier("Win32_DiskDrive WHERE DeviceID = \"\\\\\\\\.\\\\PHYSICALDRIVE0\"", "Signature");

        }

        private string DiskNo()
        {
            return Identifier("Win32_DiskDrive WHERE DeviceID = \"\\\\\\\\.\\\\PHYSICALDRIVE0\"", "SerialNumber");
        ...
        {
            return Identifier("Win32_Processor", "SystemName");
